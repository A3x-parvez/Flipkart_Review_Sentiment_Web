...
##  models path
epoch_3_model_path='Backend_API/3_epoch_sentiment_model'


epoch_8_model_path='Backend_API/8_epoch_sentiment_model'

# Load model from local folder
model = TFBertForSequenceClassification.from_pretrained(epoch_8_model_path, from_pt=False, local_files_only=True)

# Load tokenizer from local folder
tokenizer = BertTokenizer.from_pretrained(epoch_8_model_path, local_files_only=True)
