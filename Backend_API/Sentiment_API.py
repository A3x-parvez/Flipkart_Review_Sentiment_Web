...
def Fetch_Product_reviews():
    try:
        ...
        # review_lists = get_review_text(sentiment_df)
        # if isinstance(review_lists, dict) and 'error' in review_lists:
        #   print("Error in get_review_text:", review_lists["error"])
        #   return jsonify(review_lists), 400

        # positive_reviews, negative_reviews, neutral_reviews = review_lists
